...
{
    ui->setupUi(this);
    this->setFixedSize(QSize(width(), height()));//Установить фиксированный размер окна
    setWindowIcon(QIcon(":/app/icon/Ruble-RUB-icon.png"));//Установка иконки для главного окна
    DefaultData defaultData;// Данные по умолчанию
    ...
    formAbout = new FormAbout(this); // Создание окна "О программе Учет расходов и доходов"
